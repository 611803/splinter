...
- issue #24 remove save_and_open_page method from cksplinter api. This feature is out of splinter's scope, hence should be implemented as an external package.
